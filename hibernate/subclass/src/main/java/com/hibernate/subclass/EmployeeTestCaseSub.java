...
public class EmployeeTestCaseSub 
{
	...
	{
		Hourly_Employee_Sub e = new Hourly_Employee_Sub();
	...
	public static void readEmployee() throws Exception
	{
		...
		Session ses = sf.openSession();
		Object o = ses.get(EmployeeSub.class, no);
		if(o instanceof Salaried_Employee_Sub)
		{
			System.out.println("This is a salariedEmployee:");
			Salaried_Employee_Sub e = (Salaried_Employee_Sub)o;
		...
		else
		{
			...
			Hourly_Employee_Sub e = (Hourly_Employee_Sub)o;
			System.out.println("Name : " + e.getName());
